...
- **Admin Add Trip:** Saving without required fields (trip name, departure time, target grade classes, operating days) shows “Please fill in: …” naming the missing fields — not a generic “Failed to save schedule”.
